package com.akashark.agentbuddy.android.auth
...
import com.akashark.agentbuddy.android.state.ChatGPTOAuthTokenBundle
...
class ChatGPTOAuthActivity : ComponentActivity() {
    ...
    companion object {
        const val ACTION_BROWSER_RETURN = "com.akashark.agentbuddy.android.auth.CHATGPT_BROWSER_RETURN"
        private const val APP_RETURN_HOST = "chatgpt-auth-complete"
        private val APP_RETURN_URI: Uri = Uri.Builder()
            .scheme("agentbuddyauth")
        ...
        Column(
            ...
            Text(
                text = if (browserOpened) {
                    ...
                    "Google blocks sign-in inside embedded web views, so AgentBuddy uses your browser for this flow."
                },

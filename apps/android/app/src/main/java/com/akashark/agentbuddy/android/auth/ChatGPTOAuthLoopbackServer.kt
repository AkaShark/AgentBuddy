...
import com.akashark.agentbuddy.android.state.ChatGPTOAuthException
    ...
    companion object {
        ...
        internal fun successHtml(appReturnUri: String): String = """
            ...
            <head>
              ...
              <title>AgentBuddy Login Complete</title>
            ...
            <body>
              <main>
                ...
                <p>Returning to AgentBuddy. If nothing happens, <a href="$appReturnUri">tap here</a>.</p>
              </main>
            </body>
            </html>
        """.trimIndent()

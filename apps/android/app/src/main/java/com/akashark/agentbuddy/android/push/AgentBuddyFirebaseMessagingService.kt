...
import com.akashark.agentbuddy.android.state.latestAssistantSnippet
import com.akashark.agentbuddy.android.state.resolvedModel
import com.akashark.agentbuddy.android.state.resolvedPreview
    ...
    private suspend fun refreshTurnFromPush(data: Map<String, String>) {
        ...
        try {
            ...
            try {
                ...
                LLog.w(
                    "AgentBuddyFirebaseMessagingService",
            ...
            if (thread == null) {
                LLog.i("AgentBuddyFirebaseMessagingService", "Push wake refreshed but thread was unavailable")
                return
            }
            ...
            LLog.e("AgentBuddyFirebaseMessagingService", "Push wake refresh failed", error)
        } finally {
            appModel.stop()
        }
    }

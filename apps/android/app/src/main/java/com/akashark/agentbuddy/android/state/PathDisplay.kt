 ...
 * `/tmp/x.txt` instead of the raw `/data/user/0/com.akashark.agentbuddy/files/...`
 * absolute paths.
 *
...
object PathDisplay {
    ...
    private fun realTmp(): String {
        // Set by `Java_com_akashark_agentbuddy_android_core_bridge_UniffiInit_nativeBridgeInit`

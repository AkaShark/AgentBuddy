...
import com.akashark.agentbuddy.android.ui.pets.PetAvatarBubble
...
class PetOverlayService : LifecycleService() {
    companion object {
        const val ACTION_SYNC = "com.akashark.agentbuddy.android.pet.ACTION_SYNC"
        const val ACTION_HIDE = "com.akashark.agentbuddy.android.pet.ACTION_HIDE"
    }
...
private fun PetActionMenu(
    ...
    Column(
        modifier = Modifier
            .offset(x = 12.dp)
            .background(
                color = AgentBuddyTheme.surface.copy(alpha = 0.96f),
                shape = RoundedCornerShape(12.dp),
            )
            .border(
                width = 1.dp,
                color = AgentBuddyTheme.border.copy(alpha = 0.92f),
                shape = RoundedCornerShape(12.dp),
            )
            .padding(horizontal = 12.dp, vertical = 10.dp),
        verticalArrangement = Arrangement.spacedBy(8.dp),
    ) {
        PetActionMenuItem(label = "Open AgentBuddy", onClick = onOpenLitter)

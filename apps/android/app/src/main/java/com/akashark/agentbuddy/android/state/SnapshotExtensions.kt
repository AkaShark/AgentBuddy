 ...
 */
val AppServerSnapshot.statusDotState: com.akashark.agentbuddy.android.ui.common.StatusDotState
    get() = when {
        currentConnectionStep?.state == AppConnectionStepState.FAILED ->
            com.akashark.agentbuddy.android.ui.common.StatusDotState.ERROR
        currentConnectionStep?.state == AppConnectionStepState.AWAITING_USER_INPUT ->
            com.akashark.agentbuddy.android.ui.common.StatusDotState.PENDING
        ...
        transportState == AppServerTransportState.CONNECTED ->
            com.akashark.agentbuddy.android.ui.common.StatusDotState.OK
        transportState == AppServerTransportState.CONNECTING ->
            com.akashark.agentbuddy.android.ui.common.StatusDotState.PENDING
        transportState == AppServerTransportState.UNRESPONSIVE ->
            com.akashark.agentbuddy.android.ui.common.StatusDotState.PENDING
        else -> com.akashark.agentbuddy.android.ui.common.StatusDotState.IDLE
    }

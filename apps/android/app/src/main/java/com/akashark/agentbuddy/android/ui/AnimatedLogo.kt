...
fun AnimatedLogo(size: Dp = 44.dp) {
    // [baozi-fork] Top brand mark is the brand loaf image (matches iOS), replacing
    // the original procedurally-drawn kittens-in-a-litterbox logo.
    Image(
        painter = painterResource(id = com.akashark.agentbuddy.android.R.drawable.brand_logo),

...
object ExperimentalFeatures {
    private const val PREFS = "agentbuddy_ui_prefs"
    private const val KEY = "agentbuddy.experimentalFeatures"
    ...
    fun isEnabled(feature: AgentBuddyFeature): Boolean {
        return overrides[feature.id] ?: feature.defaultEnabled
    }

    fun setEnabled(context: Context, feature: AgentBuddyFeature, enabled: Boolean) {

 ...
 * values so `AgentBuddyTextStyle.<role>.scaled` produces the same physical size
 * as iOS's `.agentBuddyFont(size:)` at equal app-level scales.
 *
 * If you change these, change the iOS side at Extensions.swift:122 too.
 */
object AgentBuddyTextStyle {

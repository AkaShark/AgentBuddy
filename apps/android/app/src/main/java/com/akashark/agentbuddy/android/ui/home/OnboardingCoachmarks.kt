...
private fun CoachmarkLabel(
    ...
    Box(modifier = modifier, contentAlignment = alignment) {
        androidx.compose.foundation.layout.Column(
            ...
            val shadow = if (AgentBuddyTheme.isDark) {
...
private fun androidx.compose.ui.graphics.drawscope.DrawScope.drawCoachmarkHalo(
    ...
    drawCircle(
        color = AgentBuddyTheme.accent.copy(alpha = outerOpacity),
        radius = radius * scale,
...
private fun androidx.compose.ui.graphics.drawscope.DrawScope.drawCoachmarkArrow(
    ...
    drawPath(
        path = path,
        color = AgentBuddyTheme.accent.copy(alpha = if (isPrimary) 0.95f else 0.80f),
    ...
    drawPath(head, AgentBuddyTheme.accent.copy(alpha = if (isPrimary) 0.95f else 0.9f))
}

    ...
    Row(
        ...
        Row(
            modifier = rowModifier
                ...
                .background(
                    color = AgentBuddyTheme.textPrimary.copy(alpha = 0.06f),
                    shape = CircleShape,
                )
                .border(
                    width = if (isExpanded) 1.dp else 0.5.dp,
                    color = if (isExpanded) AgentBuddyTheme.accent.copy(alpha = 0.5f)
                    else AgentBuddyTheme.textMuted.copy(alpha = 0.25f),
                    shape = CircleShape,
                )
            ...
            Icon(
                ...
                tint = if (isExpanded) AgentBuddyTheme.accent else AgentBuddyTheme.textSecondary,

...
enum class TerminalThemeChoice(val id: String, val title: String) {
    AGENTBUDDY_DARK("agentbuddy-dark", "搭子 深色"),
    ...
    fun toPreset(): TerminalThemePreset = when (this) {
        AGENTBUDDY_DARK -> TerminalThemePreset.LitterDark
...
object TerminalConfigPrefs {
    private const val PREFS = "agentbuddy_terminal_prefs"

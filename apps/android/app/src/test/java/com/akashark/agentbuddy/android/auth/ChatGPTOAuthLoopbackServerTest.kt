...
class ChatGPTOAuthLoopbackServerTest {
    ...
    fun successHtml_mentionsReturnToApp() {
        val html = ChatGPTOAuthLoopbackServer.successHtml("agentbuddyauth://chatgpt-auth-complete")
        assertTrue(html.contains("Returning to AgentBuddy"))
        assertTrue(html.contains("agentbuddyauth://chatgpt-auth-complete"))
    }
}

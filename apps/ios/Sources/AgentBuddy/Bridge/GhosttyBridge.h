...
typedef void (^AgentBuddyGhosttyInputHandler)(NSData *data);
...
} AgentBuddyGhosttySurfaceMetrics;

@interface AgentBuddyGhosttyTerminal : NSObject

@property (nonatomic, copy, nullable) AgentBuddyGhosttyInputHandler inputHandler;
...
typedef NS_ENUM(int, AgentBuddyGhosttyKey) {
    AgentBuddyGhosttyKeyUnidentified = 0,
    AgentBuddyGhosttyKeyEnter,
    AgentBuddyGhosttyKeyTab,
    AgentBuddyGhosttyKeyBackspace,
    AgentBuddyGhosttyKeyEscape,
    AgentBuddyGhosttyKeySpace,
    AgentBuddyGhosttyKeyArrowUp,
    AgentBuddyGhosttyKeyArrowDown,
    AgentBuddyGhosttyKeyArrowLeft,
    AgentBuddyGhosttyKeyArrowRight,
    AgentBuddyGhosttyKeyPageUp,
    AgentBuddyGhosttyKeyPageDown,
    AgentBuddyGhosttyKeyHome,
    AgentBuddyGhosttyKeyEnd,
    AgentBuddyGhosttyKeyDelete,
    AgentBuddyGhosttyKeyInsert,
};

// Key dispatch. `action` 0=release, 1=press, 2=repeat.
// `key` is a `AgentBuddyGhosttyKey` from the table above; the bridge translates

...
extension View {
    func agentBuddyFont(size: CGFloat, weight: Font.Weight = .regular) -> some View {
        modifier(ScaledSizeFontModifier(size: size, weight: weight))
    }

    func agentBuddyFont(_ style: Font.TextStyle, weight: Font.Weight = .regular) -> some View {
        modifier(ScaledStyleFontModifier(style: style, weight: weight))
    }

    func agentBuddyMonoFont(size: CGFloat, weight: Font.Weight = .regular) -> some View {
...
private struct ScaledSizeFontModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(AgentBuddyFont.styled(size: size, weight: weight, scale: textScale))
    }
}
...
private struct ScaledStyleFontModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(AgentBuddyFont.styled(style, weight: weight, scale: textScale))
    }
}
...
private struct ScaledMonoFontModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(AgentBuddyFont.monospaced(size: size, weight: weight, scale: textScale))
    }
}
            ...
            content
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: cornerRadius)
                        .stroke((tint ?? AgentBuddyTheme.border).opacity(0.4), lineWidth: 1)
                )
        }
    }
}
...
struct GlassRoundedRectModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        if #available(iOS 26.0, *) {
            ...
            content
                .background(AgentBuddyTheme.surfaceLight)

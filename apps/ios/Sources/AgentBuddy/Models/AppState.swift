...
final class AppState {
    ...
    private static let approvalPolicyKey = "agentbuddy.approvalPolicy"
    private static let sandboxModeKey = "agentbuddy.sandboxMode"
    private static let preferredModelKey = "agentbuddy.preferredModel"
    private static let preferredAgentRuntimeKindKey = "agentbuddy.preferredAgentRuntimeKind"
    private static let preferredReasoningEffortKey = "agentbuddy.preferredReasoningEffort"

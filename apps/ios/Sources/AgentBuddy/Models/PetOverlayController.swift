...
final class PetOverlayController {
    ...
    private let visibleKey = "agentbuddy.petOverlay.visible"
    private let serverIdKey = "agentbuddy.petOverlay.serverId"
    private let petIdKey = "agentbuddy.petOverlay.petId"
    private let petNameKey = "agentbuddy.petOverlay.petName"
    private let petScaleKey = "agentbuddy.petOverlay.petScale"

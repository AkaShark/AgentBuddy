...
extension Notification.Name {
    static let agentBuddySavedServersDidChange = Notification.Name("agentBuddySavedServersDidChange")
}
...
enum SavedServerStore {
    ...
    static func save(_ servers: [SavedServer]) {
        ...
        NotificationCenter.default.post(name: .agentBuddySavedServersDidChange, object: nil)
    }
    ...
    static func load() -> [SavedServer] {
        ...
        let migrated = decoded.map { saved -> SavedServer in
            ...
            if shouldReplaceLegacyLocalPlaceholder(restored) {
                return restored.withName(AgentBuddyPlatform.localRuntimeDisplayName())
            }

...
enum VoiceSessionControl {
    ...
    static let defaultPrompt = "You are Codex in a live voice conversation inside AgentBuddy. Keep responses short, spoken, and conversational. Avoid markdown and code formatting unless explicitly asked."
    ...
    static let endRequestDarwinNotification = "com.akashark.agentbuddy.voice_session.end_request"

...
struct AnimatedSplashView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // [baozi-fork] AgentBuddy logo replaces the procedural litter kittens.
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 0) {
            SpinningWordCarousel(
                ...
                itemHeight: 18,
                fontSize: 14,
                selectedColor: AgentBuddyTheme.textSecondary,
                dimColor: AgentBuddyTheme.textMuted
            )

            Text(" on your phone")
                .agentBuddyMonoFont(size: 14, weight: .regular)
            ...
            ZStack(alignment: .trailing) {
                ForEach(Array(providers.enumerated()), id: \.element.id) { i, provider in
                    ...
                    HStack(spacing: 5) {
                        ...
                        Text(provider.label)
                            .agentBuddyMonoFont(size: fontSize, weight: .regular)

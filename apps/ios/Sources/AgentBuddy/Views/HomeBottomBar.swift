...
struct HomeBottomBar: View {
    ...
    private var plusButton: some View {
        ...
        .overlay(
            Capsule(style: .continuous)
                .stroke(AgentBuddyTheme.accent.opacity(0.5), lineWidth: 0.8)
    ...
    private var searchIconButton: some View {
        ...
        .overlay(
            Capsule(style: .continuous)
                .stroke(AgentBuddyTheme.textMuted.opacity(0.3), lineWidth: 0.6)
                .allowsHitTesting(false)
        )
    ...
    private var searchRow: some View {
        ...
        .overlay(
            Capsule(style: .continuous)
                .stroke(AgentBuddyTheme.accent.opacity(0.5), lineWidth: 1.0)
                .allowsHitTesting(false)
        )
        .glassMorphID(searchID, in: ns)
        .padding(.horizontal, 14)

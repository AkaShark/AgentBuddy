...
struct LockScreenCardView: View {
    ...
    private var cardBackground: Color { AgentBuddyPalette.surface.color(for: colorScheme) }
    private var logoBackground: Color { AgentBuddyPalette.surfaceLight.color(for: colorScheme) }
    private var primaryText: Color { AgentBuddyPalette.textPrimary.color(for: colorScheme) }
    private var secondaryText: Color { AgentBuddyPalette.textSecondary.color(for: colorScheme) }
    private var tertiaryText: Color { AgentBuddyPalette.textMuted.color(for: colorScheme) }
    ...
    private var dangerText: Color { AgentBuddyPalette.danger.color(for: colorScheme) }
    private var warningText: Color { AgentBuddyPalette.warning.color(for: colorScheme) }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(alignment: .center, spacing: 10) {
                ...
                Text(prompt)
                    .font(.system(size: 13, weight: .medium, design: AgentBuddyPalette.fontDesign))
            ...
            Text(displayText)
                .font(.system(size: 11, design: AgentBuddyPalette.fontDesign))

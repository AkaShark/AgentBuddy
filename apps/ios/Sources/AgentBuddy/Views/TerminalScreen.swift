...
struct TerminalScreen: View {
    ...
    @AppStorage("agentbuddy.terminal.fontSize") private var storedFontSize: Double = 13.0
    @AppStorage("agentbuddy.terminal.themeId") private var storedThemeId: String = "litter-dark"
    @AppStorage("agentbuddy.terminal.cursorBlink") private var storedCursorBlink: Bool = true

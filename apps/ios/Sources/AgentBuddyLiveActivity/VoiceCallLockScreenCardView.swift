...
struct VoiceCallLockScreenCardView: View {
            ...
            HStack(spacing: 8) {
                ...
                Button(intent: EndVoiceSessionIntent()) {
                    Image(systemName: "xmark.circle.fill")
                        ...
                        .padding(8)
                        .background(Circle().fill(AgentBuddyPalette.danger.color(for: colorScheme)))
                }
                .buttonStyle(.plain)
            }
            .padding(.top, 10)
    ...
    private var phaseColor: Color {
        ...
        case .connecting, .thinking:
            return AgentBuddyPalette.warning.color(for: colorScheme)
        case .listening, .speaking:
            return AgentBuddyPalette.accent.color(for: colorScheme)
        case .error:
            return AgentBuddyPalette.danger.color(for: colorScheme)
        }
    }

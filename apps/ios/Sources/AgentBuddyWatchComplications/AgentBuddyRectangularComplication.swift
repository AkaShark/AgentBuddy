...
struct AgentBuddyRectangularComplication: Widget {
    let kind = "AgentBuddyRectangularComplication"
    ...
    var body: some WidgetConfiguration {
        AppIntentConfiguration(
            ...
            AgentBuddyRectangularView(entry: entry)
                .widgetAccentable()
...
struct AgentBuddyRectangularView: View {

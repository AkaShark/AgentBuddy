...
TEAM_ID="${TEAM_ID:-}"
PROVISIONING_PROFILE_SPECIFIER="${PROVISIONING_PROFILE_SPECIFIER:-AgentBuddy App Store}"
APP_PROVISIONING_PROFILE_SPECIFIER="${APP_PROVISIONING_PROFILE_SPECIFIER:-$PROVISIONING_PROFILE_SPECIFIER}"
LIVE_ACTIVITY_BUNDLE_ID="${LIVE_ACTIVITY_BUNDLE_ID:-com.akashark.agentbuddy.liveactivity}"
LIVE_ACTIVITY_PROVISIONING_PROFILE_SPECIFIER="${LIVE_ACTIVITY_PROVISIONING_PROFILE_SPECIFIER:-}"
WATCH_BUNDLE_ID="${WATCH_BUNDLE_ID:-com.akashark.agentbuddy.watchkitapp}"
WATCH_PROVISIONING_PROFILE_SPECIFIER="${WATCH_PROVISIONING_PROFILE_SPECIFIER:-}"
WATCH_COMP_BUNDLE_ID="${WATCH_COMP_BUNDLE_ID:-com.akashark.agentbuddy.watchkitapp.complications}"

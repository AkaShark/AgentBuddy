...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_akashark_agentbuddy_android_core_bridge_UniffiInit_nativeBridgeInit(
    mut env: JNIEnv,
    _class: JClass,
    home_dir: JString,
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_akashark_agentbuddy_android_core_bridge_NativeCodexBridge_nativeStartServerPort(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
    -1
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_akashark_agentbuddy_android_core_bridge_NativeCodexBridge_nativeStopServer(
    _env: JNIEnv,
    _class: JClass,
) {
}
